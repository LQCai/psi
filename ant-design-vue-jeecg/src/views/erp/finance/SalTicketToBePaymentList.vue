...
<!--          <a @click='handleEdit(record)'>编辑</a>-->
          <a v-has="'SalTicket:receipts'" @click='handleReceipts(record)' v-if='record.status === 4'>收款</a>

          <a-divider v-has="'SalTicket:receipts'" v-if='record.status === 4' type='vertical' />
          <a-dropdown>
