  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/finance/finReceipt/list/100",
          ...
          exportXlsUrl: "/finance/finReceipt/exportXls/100",
          importExcelUrl: "finance/finReceipt/importExcel/100",
        },
        dictOptions:{},
      }
    },
