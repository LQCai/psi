  ...
  <a-drawer
    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" prop="invoiceType" label="发票类型">
          <a-input placeholder="请输入发票类型" v-model="model.invoiceType" />
        </a-form-model-item>
        ...
        <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" prop="status" label="状态(1 = 正常, 2 = 失效)">
  ...
  data () {
    return {
      ...
      validatorRules:{
        ...
        status:[{ required: true, message: '请输入状态(1 = 正常, 2 = 失效)!' }],
      },
      url: {
        add: "/sale/salShoppingCart/add",
        edit: "/sale/salShoppingCart/edit",
      },
    }
  },
  created () {
