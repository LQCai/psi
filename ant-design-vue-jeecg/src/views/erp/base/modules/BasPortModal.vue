    ...
    return {
      ...
      validatorRules: {
        code: [
          ...
          { validator: (rule, value, callback) => validateDuplicateValue('bas_port', 'code', value, this.model.id, callback) }
        ],
        name: [
          { required: true, message: '请输入名称!'},
          { validator: (rule, value, callback) => validateDuplicateValue('bas_port', 'name', value, this.model.id, callback) }
        ],
        auxName: [
          { required: true, message: '请输入助记名!'},
          { validator: (rule, value, callback) => validateDuplicateValue('bas_port', 'aux_name', value, this.model.id, callback) }
        ],
      },
      url: {
        add: "/base/basPort/add",
        edit: "/base/basPort/edit",
      },
      expandedRowKeys:[],
      pidField:"pid"
