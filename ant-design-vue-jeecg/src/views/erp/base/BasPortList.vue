<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link" icon="download" @click="handleExportXls('港口')">导出</a-button>
    ...
    <basPort-modal ref="modalForm" @ok="modalFormOk"></basPort-modal>
  </a-card>
</template>
...
import BasPortModal from './modules/BasPortModal'
import { filterObj } from '@/utils/util';

export default {
  name: "BasPortList",
  mixins:[JeecgListMixin, ListMixin],
  components: {BasPortModal},
  ...
  data () {
    return {
      ...
      url: {
        list: "/base/basPort/rootList",
        childList: "/base/basPort/childList",
        getChildListBatch: "/base/basPort/getChildListBatch",
        delete: "/base/basPort/delete",
        deleteBatch: "/base/basPort/deleteBatch",
        exportXlsUrl: "/base/basPort/exportXls",
        importExcelUrl: "bas/basPort/importExcel",
      },
      expandedRowKeys:[],
