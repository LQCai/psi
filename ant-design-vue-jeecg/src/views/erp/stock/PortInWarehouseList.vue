<template>
  <a-card :bordered="false">
    ...
    <port-in-warehouse-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
import PortInWarehouseModal from './modules/PortInWarehouseModal'
import TableColumnsSetter from '../common/components/TableColumnsSetter'
import { BillListMixin } from '../common/mixins/BillListMixin'

export default {
  name: "PortInWarehouseList",
  mixins:[JeecgListMixin, BillListMixin],
  components: {TableColumnsSetter, PortInWarehouseModal},
  ...
  data () {
    return {
      ...
      url: {
        ...
        exportXlsUrl: "/stock/stkIo/exportXls/200",
        importExcelUrl: "stock/stkIo/importExcel/200",
      },
      dictOptions:{},
    }
  },
