...
<!--            </a-col>-->
    ...
    <port-in-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  import PortInModal from './modules/PortInModal'
  ...
  export default {
    ...
    components: { PortInModal, TableColumnsSetter },
    ...
    data () {
      return {
        ...
        url: {
          list: "/port/portIo/list/101/0",
          delete: "/port/portIo/delete",
          deleteBatch: "/port/portIo/deleteBatch",
          close: "/port/portIo/close",
          closeBatch: "/port/portIo/closeBatch",
          unclose: "/port/portIo/unclose",
          uncloseBatch: "/port/portIo/uncloseBatch",
          exportXlsUrl: "/port/portIo/exportXls/101/0",
          importExcelUrl: "port/portIo/importExcel/101/0",
        },
        dictOptions:{},
      }
    },
