...
<!--        </a-row>-->
        ...
        <a-row>
          ...
          <a-col :span="8">
            <a-form-model-item label="免柜时间" :labelCol="labelCol3" :wrapperCol="wrapperCol3" prop="freeDemurrage">
              <a-input v-model="model.freeDemurrage" type='number'/>
            </a-form-model-item>
          </a-col>
          <a-col :span="8">
            <a-form-model-item label="提前提醒天数" :labelCol="labelCol3" :wrapperCol="wrapperCol3" prop="notifyPreDays">
              <a-input v-model="model.notifyPreDays" type='number'/>
            </a-form-model-item>
          </a-col>
...
<script>
  ...
  import BillHeader from "../../common/components/BillHeaderNotApproval";
  import BillFooter from "../../common/components/BillFooterNotApproval";
  ...
  export default {
    ...
    data() {
      return {
        model: {//设置初始值的属性、程序赋值的响应式属性
          ...
          opDept: '',
          invoiceType: '',
          inPortTime: new Date().format('yyyy-MM-dd hh:mm:00'),
          freeDemurrage: 5,
          notifyPreDays: 3
        },
        ...
        entryTable: {
          ...
          rowCount: 0,
          selectedRowCount: 0,
          url: {list: '/port/portIo/queryEntryByMainId'},
        ...
        url: {
          add: "/port/portIo/add",
          edit: "/port/portIo/edit",
          check: "/port/portIo/check",
          ebpm: "/port/portIo/bpm/end",
          execute: "/port/portIo/execute",
          void: "/port/portIo/void",
        },
      }
    },
    ...
    methods: {
      ...
      classifyIntoFormData(allValues) {
        ...
        return {
          ...main, // 展开
          portIoEntryList: allValues.tablesValue[0].tableData,
        }
      },
      ...
      onEntryValueChange(event) {
        ...
        switch (column.property) {
          ...
          case "settleQty":
            ...
            values.qty = Number(row.settleQty);
