<template>
  <j-modal
    ...
    <port-in-warehouse-form ref="realForm" @ok="submitCallback" :disabled="disableSubmit"/>
  </j-modal>
</template>
...
<script>
  ...
  import PortInWarehouseForm from "./PortInWarehouseForm";

  export default {
    name: 'PortInWarehouseModal',
    mixins: [BillModalMixin],
    components: {PortInWarehouseForm},
