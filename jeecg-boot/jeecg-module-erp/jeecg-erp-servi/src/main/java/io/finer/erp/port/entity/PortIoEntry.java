...
@TableName("port_io_entry")
public class PortIoEntry extends Entry {
	/**物料*/
	...
	/**出入方向*/
	@Excel(name = "出入方向", width = 15, dicCode = "x_port_io_direction")
	@Dict(dicCode = "x_port_io_direction")
	@ApiModelProperty(value = "出入方向")
	private String portIoDirection;
	/**供应商*/
